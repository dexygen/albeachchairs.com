    ...
    <div class="columns is-mobile">
      <main class="column mx-3 has-text-centered">
        <header>
          ...
          <div class="has-text-success-dark is-size-3 mb-4 font-pangolin">
            ...
            <article class="columns is-mobile is-centered font-pangolin">
              <div class="column is-10 offset-1 has-text-centered">
                ...
                <ul class="is-size-4">
                  ...
                  <li>(Securely fastened by one of our friendly attendants)</li>
                  <li class="mt-2">
                    <a class="is-underlined" href="#abc-chair-set-pricing">Tap or scroll down for pricing (left column)</a>
                  </li>
                  <li class="mb-2">(Only the "full" 1-7 day rates -- no hourly)</li>
