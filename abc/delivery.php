...
<html lang="en">
  <head>
    ...
    <title>Alabama Beach Chairs, provider of beach equipment to Orange Beach and Gulf Shores, offers convenient online reservations, for service to your beach home</title>
    <style>
  ...
  <body id="abc-viewport" class="has-text-centered px-1"><html>
    ...
    <?php require("./includes/content/delivery.content.php"); ?>
  </body>
</html>